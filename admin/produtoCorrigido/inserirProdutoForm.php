        ...
        <div class="col-md-8 p-5">
            ...
            <form action="inserirProduto.php" method="post" enctype="multipart/form-data">
                    ...
                    <select
                        ...
                        <?php
                            ...
                            while ($dadosCategoria = mysqli_fetch_assoc($resultCategoria)) {
                                echo "<option value='" . (int) $dadosCategoria['idCategoria'] . "'>" . htmlspecialchars($dadosCategoria['nomeCategoria']) . "</option>";
                            }
                        ?>
                    ...
                    <select
                        ...
                        <?php
                            ...
                            while ($dadosLoja = mysqli_fetch_assoc($resultLoja)) {
                                echo "<option value='" . (int) $dadosLoja['idLoja'] . "'>" . htmlspecialchars($dadosLoja['nomeLoja']) . "</option>";
                            }
                        ?>
                    ...
                    <select
                        ...
                        <?php
                            ...
                            while ($dadosUsuario = mysqli_fetch_assoc($resultUsuario)) {
                                echo "<option value='" . (int) $dadosUsuario['idUsuario'] . "'>" . htmlspecialchars($dadosUsuario['nomeUsuario']) . "</option>";
                            }
                        ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="descontoProduto" class="form-label">
                            Desconto (%):
                        </label>
                        <input
                            type="number"
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="cashbackProduto" class="form-label">
                            Cashback (%):
                        </label>
                        <input
                            type="number"
